		...
		<div>
			...
			<div id="box2" class="col-md-4 col-xs-12">
				<div>
					...
					<div id="box3" class="col-md-4 col-xs-12 hidden-xs hidden-sm">
						<div>
							<div>
								<div>
									<h6><i class="fa fa-circle-o "></i> AVNETWORKS</h6>
								</div>
								<style type="text/css">.col-md-3 i {color:#fff;}</style>
								
								<yo id="networks">
								<div class="col-md-3"><a href="https://facebook.com/aldrigvila" target="_blank" title="AldrigVila Facebook" rel="external"><div><i class="fa fa-facebook fa-lg"></i></div></a></div>
								<div class="col-md-3"><a href="https://twitter.com/AVMHollsten" target="_blank" title="AldrigVila Twitter" rel="external"><div><i class="fa fa-twitter fa-lg"></i></div></a></div>
								<div class="col-md-3"><a href="https://instagram.com/avmhollsten" target="_blank" title="AldrigVila Instagram" rel="external"><div><i class="fa fa-instagram fa-lg"></i></div></a></div>
								<div class="col-md-3"><a href="https://youtube.com/aldrigvila" target="_blank" title="AldrigVila Youtube" rel="external"><div><i class="fa fa-youtube fa-lg"></i></div></a></div>
								<div class="col-md-6">
									<a href="http://store.aldrigvila.se" target="_blank"><div><p>SHOP</p></div></a>
								</div>

								<div class="col-md-6">
									<a href="/blog" target="_blank"><div><p>BLOG</p></div></a>
								</div>
								<div class="col-md-12">
